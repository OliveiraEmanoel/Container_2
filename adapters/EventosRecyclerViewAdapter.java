...
public class EventosRecyclerViewAdapter extends RecyclerView.Adapter<EventosRecyclerViewAdapter.ViewHolder> {
    ...
    public EventosRecyclerViewAdapter(Context context, List<Eventos> eventos) {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        Log.d(TAG, "position = " + position + "title = " + evento.getNomeEvento());
        //TextView tvNameItemRoupas = (TextView) v.findViewById(R.id.tv_name_item_roupas);

        holder.tvNomeEvento.setText(evento.getNomeEvento());
        ...
        holder.tvDescricaoEvento.setText(evento.getDescricaoEvento());
        ...
        picasso.get()
                ...
                .into(holder.ivEvento, new Callback() {
                    ...
                    public void onError(Exception e) {
                        Log.e(TAG, "onError: " + e.toString() + evento.getPhotoPath().toString());
                        // hideProgressDialog();
                    }
